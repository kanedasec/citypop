#!/usr/bin/env python3
# @name: WiFi Manager Payload
# @desc: Launch the WiFi management interface in RaspyJack.
# @category: utilities
# @danger: false
# @active: true
# @web: true
...
sys.path.append(os.path.join(os.environ.get("CITYPOP_ROOT", os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))), 'wifi'))
...
def main():
    ...
    try:
        ...
        wifi_interface_path = os.path.join(os.environ.get("CITYPOP_ROOT", os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))), 'wifi', 'wifi_lcd_interface.py')
