...
LOOT_DIR       = Path(os.path.join(os.environ.get("CITYPOP_ROOT", os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))), 'loot'))
MITM_DIR       = LOOT_DIR / "MITM"
NMAP_DIR       = LOOT_DIR / "Nmap"
RESPONDER_DIR  = Path(os.path.join(os.environ.get("CITYPOP_ROOT", os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))), 'Responder')) / "logs"

WEBHOOK_FILE = Path(os.path.join(os.environ.get("CITYPOP_ROOT", os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))), 'discord_webhook.txt'))
...
def main() -> None:
    if not WEBHOOK_URL or "xxxxxxxx" in WEBHOOK_URL:
        print(textwrap.dedent("""\
            ...
            Add your webhook URL to $CITYPOP_ROOT/discord_webhook.txt
